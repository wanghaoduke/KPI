...
@section('content')
    <style>
        a#create_Assessment:hover {
            text-decoration: none;
        }
    </style>
    <div ng-app="kpiManageApp">
    ...
    <script src="{{ asset('js/assessment/app.js') }}"></script>
    <script src="{{ asset('js/assessment/KpiModel.js') }}"></script>
    <script src="{{ asset('js/assessment/assessmentRoute.js') }}"></script>
    <script src="{{ asset('js/assessment/controllers/KpiManageController.js') }}"></script>
    <script src="{{ asset('js/assessment/controllers/CreateAssessmentDetailController.js') }}"></script>
@endsection